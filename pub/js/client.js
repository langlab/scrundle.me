...
(function() {
  var AboutView, BundleView, DocsView, Finder, NavBar, Router, Script, ScriptView, Scripts, WhyView, w,
  ...
  Script = (function(_super) {
    ...
    Script.prototype.idAttribute = "_id";
  ...
  AboutView = (function(_super) {
    ...
    AboutView.prototype["class"] = 'about-view';

    AboutView.prototype.template = function() {
      return div({
    ...
    AboutView.prototype.pullUp = function(cb) {
      var _this = this;
    ...
    AboutView.prototype.pullDown = function(cb) {
  ...
  WhyView = (function(_super) {

    __extends(WhyView, _super);

    function WhyView() {
      return WhyView.__super__.constructor.apply(this, arguments);
    }

    WhyView.prototype.tagName = 'div';

    WhyView.prototype.className = 'modal hide';

    WhyView.prototype.template = function() {
      div({
        "class": 'modal-header'
      }, function() {
    ...
    WhyView.prototype.render = function() {
      this.$el.html(ck.render(this.template));
      return this;
    };

    WhyView.prototype.open = function() {
  ...
  DocsView = (function(_super) {

    __extends(DocsView, _super);

    function DocsView() {
      return DocsView.__super__.constructor.apply(this, arguments);
    }

    DocsView.prototype.tagName = 'div';

    DocsView.prototype.className = 'docs';

    DocsView.prototype.events = {
    ...
    DocsView.prototype.loadUrl = function(code, url) {
      this.code = code;
      this.url = url;
    ...
    DocsView.prototype.template = function() {
      return div({
    ...
    DocsView.prototype.template2 = function() {
      var _ref;
      iframe({
    ...
    DocsView.prototype.render = function() {
  ...
  Router = (function(_super) {
    ...
    Router.prototype.initialize = function(session) {
      this.session = session;
      this.scripts = new Scripts();
      this.docs = new Scripts();
      return this.views = {
        navBar: new NavBar(),
        about: new AboutView(),
        finder: new Finder({
